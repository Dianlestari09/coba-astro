...
const $$About = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Main, { "title": "About Us" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="section"> <div class="container max-w-3xl prose"> <div class="breadcrumbs text-sm mb-6"> <ul class="flex! flex-wrap"> <li><a href="/">Home</a></li> <li>About Us</li> </ul> </div> <div class="post"> <h1 class="uppercase">About Us</h1> <p>
...
}, "D:/Kuliah/Magang/ProCleaning-main/src/pages/about.astro", void 0);

const $$file = "D:/Kuliah/Magang/ProCleaning-main/src/pages/about.astro";
const $$url = "/about";
